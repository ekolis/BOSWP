namespace BOSWP
{
	partial class GameForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTip.SetToolTip(this.lblHitpoints, "The total hitpoints of your ship\'s components.");
			// 
			// label2
			// 
			...
			this.toolTip.SetToolTip(this.lblShields, "Your ship\'s shields. Shields are damaged before components.");
			// 
			// label3
			// 
			...
			this.toolTip.SetToolTip(this.lblMass, "The mass of your ship. Bigger ships require more engines and crew.");
			// 
			// lblCrew
			// 
			...
			this.toolTip.SetToolTip(this.lblCrew, "The crew of your ship. If this falls below your ship\'s mass, it\'s game over!");
			// 
			// lblThrust
			// 
			...
			this.toolTip.SetToolTip(this.lblThrust, "Thrust generated by your ship\'s engines. Bigger ships need more thrust to get the" +
        " same speed.");
			// 
			// lblSpeed
			// 
			...
			this.toolTip.SetToolTip(this.lblSpeed, "Your ship\'s speed. Equal to thrust divided by mass, rounded down. If this falls t" +
        "o zero, it\'s game over!");
			// 
			// gridWeapons
			// 
			...
			this.toolTip.SetToolTip(this.gridWeapons, "Info on your ship\'s weapons.");
			// 
			// btnComponents
			// 
			...
			this.toolTip.SetToolTip(this.btnComponents, "Bring up a report on your ship.");
        ...
        "endly colony to upgrade your ship.");
			...
			this.toolTip.SetToolTip(this.galaxyMap, "Display priority\r\n\r\nPlayer ship: blue @\r\nEnemy shipyard: red #\r\nAllied colony: bl" +
        "ue o\r\nUnexplored planet: white o\r\nSector unswept with sensors: gray *\r\nNothing o" +
        "f interest: dark gray .");
			// 
			// systemMap
			// 
			...
			this.toolTip.SetToolTip(this.systemMap, resources.GetString("systemMap.ToolTip"));
